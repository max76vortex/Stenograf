...
| WS-017 | Phase B OpenAI: убрать `response_format: json_object` для LM Studio (только json_schema/text) | Open | 2026-04-13 | | `phase_b_processor.py` `call_openai_compatible_json`; полный recursive-прогон после фикса |
